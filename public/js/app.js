  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FilterContainer, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("aside", {
        id: "filter-side",
        className: "md:w-3/12 order-0 md:order-1 flex flex-col md:flex md:flex-col"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        className: "w-full md:pl-4 mb-5"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(StatContainer, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        ...
        className: "shadow pl-4 px-3 py-2 rounded w-full"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", {
        className: "uppercase text-center text-sm font-bold text-heading"
      }, "\u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430 ", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("br", null), "\u0437\u0430 \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0434\u0435\u043D\u044C"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("ul", {
        className: "mt-3 flex flex-wrap"
      }, data.map(function (item, index) {
        var imgUrl = 'storage/type/' + item.img_url;
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("li", {
          key: index + '_url',
          className: "flex flex-col rounded border border-border m-1 items-center p-2"
...
function (_React$Component) {
  ...
  function TableContainer(props) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "onLoadMore", function () {
      var filter = _this.state.filter;
      filter.show += 10;

      _this.setState(filter, function () {
        _this.syncData();
      });
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(TableContainer, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        className: "md:w-9/12 order-1 flex flex-col"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("table", {
        className: "table-auto w-full shadow"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("thead", null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("tr", null, tableHeaders.map(function (item, index) {
        var classes = 'hidden md:table-cell px-6 uppercase border-b border-border text-heading ';
        ...
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_TableRow__WEBPACK_IMPORTED_MODULE_9__["default"], {
          ...
          var classNames = itemH.classes + ' flex-wrap';
          ...
          var datePublish = new Date(text);
          return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("td", {
            className: classNames + ' text-center',
            key: indexH + '_td'
          }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("span", {
            className: ""
          }, datePublish.toLocaleDateString()));
        }));
      ...
      }, "Load More")), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Filter_FilterContainer__WEBPACK_IMPORTED_MODULE_10__["default"], {
        onChangeFilter: this.changeFilter
      }));
    }
  }]);
